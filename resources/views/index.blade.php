...
<body>
    ...
    <section id="topbar" class="d-flex align-items-center">
        <div class="container d-flex justify-content-center justify-content-md-between">
            ...
            <div class="social-links d-none d-md-block">
                ...
                <a href="https://www.instagram.com/colpomed/?hl=es" class="instagram"><i
                        class="bi bi-instagram"></i></a>
                <a href="https://www.youtube.com/channel/UCVdJTSJolVtqvFXgwBCkOOg" class="twitter"><i
                        class="bi bi-youtube"></i></a>
                <a href="https://www.linkedin.com/in/ximena-coronel-a82538140?originalSubdomain=ec" class="linkedin"><i
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="index.html">NUTRIDAY <span style="font-size: 15px;color:#919191">by
                        COLPOMED</span></a></h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
                        ...
                        <p class="fst-italic" style="text-align:justify">
                            Somos un Centro Hospitalario de Especialidades Médicas ubicado en la ciudad de Riobamba con
                            amplio
                            reconocimiento y experiencia en la práctica de Ginecología, Obstetricia, Patología Cervical
                            y Colposcopia.
                        </p>
                        <br>
                        <ul>
                            ...
                            <li><i class="bi bi-check-circle"></i>Diagnóstico, control y prevención de enfermedades
                                agudas y crónicas
                            </li>
                        </ul>
                        <br>
                        <p style="text-align:justify">
                            Nos identificamos como referentes en el manejo de la Patología del Cuello Uterino con una
                            experiencia de
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4" data-aos="fade-up">
                        <div class="box h-100">
                            <span>01</span>
                            <h4>Laboratorio</h4>
                            <p style="text-align: justify">Contamos con un área de pre analítica para recepción y toma
                                de muestras, un
                                área para analítica de inmunología, test hormonales y marcadores tumorales, pruebas de
                                Biología
                                molecular, Bioquímica Clínica, Serología y Hematología, Uroanálisis, Coproanálisis,
                                Bacteriología con
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="150">
                        <div class="box h-100">
                            ...
                            <p style="text-align: justify">En Colpomed, brindamos una experiencia médica diferente,
                                cálida y
                                agradable; con un servicio de terapias naturales que se disponen en el Centro de
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
                        <div class="box h-100">
                            <span>03</span>
                            <h4>Farmacia</h4>
                            <p style="text-align: justify">Proporcionamos el servicio de Farmacia Interna a todos los
                                usuarios de
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up">
                        <div class="icon-box">
                            ...
                            <p>El especialista en Medicina Interna, brinda atención integral al paciente, enfocándose en
                                la
                                prevención, estudio, diagnóstico, tratamiento y rehabilitación de las enfermedades
                                crónicas propias del
                                adulto.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up"
                        ...
                        <div class="icon-box">
                            ...
                            <p>Consulta externa de Medicina general con cuidados en atención primaria de salud para
                                niños, mujeres y
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="fade-up"
                        ...
                        <div class="icon-box">
                            ...
                            <p>Especialistas en Pediatría y Neonatología, atendemos a niños menores y mayores dentro de
                                un ambiente
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up"
                        ...
                        <div class="icon-box">
                            ...
                            <p>Nos identificamos como referentes en el manejo de la Patología del Cuello Uterino, con
                                una experiencia
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up"
                        ...
                        <div class="icon-box">
                            ...
                            <p>Contamos con profesionales especializados en Nutrición y Dietética, que mediante el
                                trabajo
                                interdisciplinario hacen del proceso de cuidado nutricional, parte del manejo integral
                                del paciente
        ...
        <section id="portfolio" class="portfolio">
            <div class="container">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="150">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-otros">
                        ...
                        <div class="portfolio-info">
                            ...
                            <a href="{{ asset('img/portfolio/otros.png') }}" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Noticias"><i
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-instalaciones">
                        ...
                        <div class="portfolio-info">
                            ...
                            <a href="{{ asset('img/portfolio/laboratorio.jpg') }}" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Laboratorio médico de COLPOMED"><i
                                    class="bx bx-plus"></i></a>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-consultorio">
                        <img src="{{ asset('img/portfolio/consultorio.PNG') }}" class="img-fluid w-100"
                            alt="">
                        <div class="portfolio-info">
                            <h4>Consultorio médico</h4>
                            <p>Consultorios</p>
                            <a href="{{ asset('img/portfolio/consultorio.PNG') }}" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Consultorio médico de COLPOMED"><i
                                    class="bx bx-plus"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-instalaciones">
                        ...
                        <div class="portfolio-info">
                            ...
                            <a href="{{ asset('img/portfolio/Enfermeria.PNG') }}" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Enfermería de COLPOMED"><i
                                    class="bx bx-plus"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-instalaciones">
                        ...
                        <div class="portfolio-info">
                            ...
                            <a href="{{ asset('img/portfolio/edificio.jpg') }}" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Edificio de COLPOMED"><i
                                    class="bx bx-plus"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-instalaciones">
                        <img src="{{ asset('img/portfolio/instalaciones2.PNG') }}" class="img-fluid w-100 h-100"
                            alt="">
                        <div class="portfolio-info">
                            <h4>Laboratorio</h4>
                            <p>Instalaciones</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-consultorio">
                        <img src="{{ asset('img/portfolio/consultorio3.PNG') }}" class="img-fluid w-100"
                            alt="">
                        <div class="portfolio-info">
                            <h4>Sala de espera</h4>
                            <p>Consultorios</p>
                            <a href="{{ asset('img/portfolio/consultorio3.PNG') }}" data-gallery="portfolioGallery"
                                class="portfolio-lightbox preview-link" title="Sala de espera de COLPOMED"><i
                                    class="bx bx-plus"></i></a>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-consultorio">
                        <img src="{{ asset('img/portfolio/vitaminac.jpg') }}" class="img-fluid w-100"
                            alt="">
                        <div class="portfolio-info">
                            ...
                            <a href="{{ asset('img/portfolio/vitaminac.jpg') }}" data-gallery="portfolioGallery"
                                ...
                                title="Centro de Medicina Funcional antidegenerativa, antioxidativa, y sueroterapias biorreguladoras y de infusiones de Megadosis de Vitamina C."><i
                                    class="bx bx-plus"></i></a>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-consultorio">
                        <img src="{{ asset('img/portfolio/instalaciones3.PNG') }}" class="img-fluid w-100"
                            alt="">
                        <div class="portfolio-info">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="150">
                        <div class="box h-100">
                            ...
                            <div class="container px-0 px-lg-5 ">
                                <p style="text-align:justify;">En Colpomed todos nuestros servicios integrados se
                                    complementan para
                                    brindarle a nuestros clientes una experiencia médica diferente, cálida y agradable.
                                </p>
                            </div>
                            <div class="btn-wrap">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mt-md-0" data-aos="zoom-in">
                        <div class="box featured h-100">
                            ...
                            <div class="container px-0 px-lg-5 ">
                                <p style="text-align:justify;">
                                    Nuestro sello distintivo marca su diferencia en el mercado al ser un Centro Médico
                                    que cuenta con
                                    instalaciones modernas, confortables, con normativas de seguridad y diseño
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="150">
                        <div class="box h-100">
                            ...
                            <div class="container px-0 px-lg-5 ">
                                ...
                                <p style="text-align:justify;">
                                    Nuestro actuar se basa en el respeto, la integridad y ética profesional, nuestro
                                    compromiso es
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
                        <div class="member w-100">
                            ...
                            <div class="social">
                                ...
                                <a href="https://www.instagram.com/colpomed/?hl=es"><i
                                        class="bi bi-instagram"></i></a>
                                <a href="https://www.youtube.com/channel/UCVdJTSJolVtqvFXgwBCkOOg"><i
                                        class="bi bi-youtube"></i></a>
                                <a href="https://www.linkedin.com/in/ximena-coronel-a82538140?originalSubdomain=ec"><i
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in">
                        <div class="member w-100">
                            ...
                            <div class="social">
                                ...
                                <a href="https://www.youtube.com/channel/UCVdJTSJolVtqvFXgwBCkOOg"><i
                                        class="bi bi-youtube"></i></a>
                                <a href="https://www.linkedin.com/in/ivan-naranjo-61753a140/?originalSubdomain=ec"><i
                                        class="bi bi-linkedin"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="member w-100">
                            ...
                            <div class="social">
                                ...
                                <a href="https://www.youtube.com/channel/UCVdJTSJolVtqvFXgwBCkOOg"><i
                                        class="bi bi-youtube"></i></a>
                                <a
                                    href="https://www.linkedin.com/in/anthony-naranjo-7a102b126/?originalSubdomain=ec
                "><i
                                        class="bi bi-linkedin"></i></a>
        ...
        <section id="contact" class="contact">
            <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-12 mb-3 mb-xl-0 media">
                            <div class="p-4 info-box"
                                style="border:1px solid #f9f9f905;border-radius:5px;text-align: left;">
                                <p class="text-center mb-4" style="color:#777777 !important;"> <strong>LABORATORIO
                                        CLÍNICO/INMUNOLÓGICO:</strong> </p>
                                <ul class="text-left">
                                    <li class="text-left">
                                        <strong style="color:#777777 !important;">Lunes a Viernes: </strong> 07:00 am -
                                        13:00 pm y 15:00 pm - 18:00pm
                        ...
                        <div class="col-xl-6 col-12 mediaa" style="padding-right: 0 !important;">
                            <div class="p-4 info-box"
                                style="border:1px solid #f9f9f9;border-radius:5px;text-align: left;">
                                <p class="text-center mb-4" style="color:#777777 !important;"> <strong>CONSULTAS
                                        MÉDICAS </strong> </p>
                                <ul class="">
                                    <li>
                                        <strong style="color:#777777 !important;">Lunes a Viernes:</strong> 08:00 am -
                                        12:30 pm y 15:00 pm - 18:30 pm
                ...
                <div class="row" data-aos="fade-up">
                    ...
                    <div class="col-lg-6">
                        <form action="{{ route('home.contactar') }}" method="POST" role="form"
