	...
	<body>
		...
		@include('layouts.header2')
			...
			<div role="main" class="main">
                ...
                @include('layouts.breadcrumb',["pagina"=>"Nosotros"])
						...
						<div class="col">
							<div class="overflow-hidden mb-3">
								<h2 class="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
									<span>El nuevo camino al </span>
									<span class="word-rotator-words bg-primary">
										<b class="is-visible">Logro</b>
										<b>Exito</b>
										<b>Progreso</b>
									</span>
								</h2>
						...
						<div class="row align-items-center">
							...
							<div class="col-md-6">
								<div class="overflow-hidden mb-2">
									<h2 class="text-color-dark font-weight-normal text-5 mb-0 pt-0 mt-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1200">Quienes <strong class="font-weight-extra-bold">Somos Nosotros</strong></h2>
								</div>
						...
						<div class="col-md-6">
							<div class="toggle toggle-primary toggle-simple m-0" data-plugin-toggle>
								<section class="toggle active mt-0">
									<a class="toggle-title">Nuestra visión</a>
								...
								<section class="toggle">
									<a class="toggle-title">Nuestra misión</a>
									<div class="toggle-content">
