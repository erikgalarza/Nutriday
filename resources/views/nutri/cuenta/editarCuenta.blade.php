                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-xl-5 mb-4 mb-xl-0 row justify-content-center align-items-center">
                                ...
                                <img class="img-thumbnail imaagen" style="max-width:350px;max-height:350px"
                                src="{{$nutricionista->imagen->url}}">
                                @else
                                <img class="img-thumbnail imaagen" style="max-width:350px;max-height:350px"
                                    src="{{ asset('img/icons/Nutricionista.png') }}">
                                    @endif
                            </div>
                            <div class="col-xl-7">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" name="sexo">
                                                <option value="1" {{$nutricionista->sexo === "1" ? 'selected':''}}>Masculino</option>
                                                <option value="2" {{$nutricionista->sexo === "2" ? 'selected':''}}>Femenino</option>
