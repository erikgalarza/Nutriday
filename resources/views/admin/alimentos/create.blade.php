        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class=" " style="background-color:#4b6ac3 ">
                    <h3 class="card-title text-lg-center mb-5 mt-5 text-white"
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-10" style="border:1px dashed;border-radius:8px;background-color:#F0F0F0p">
                            <div class="col-12  row justify-content-center p-2 m-0 px-0" style="min-width: 100%">
                                ...
                                <div class="col-4 form-group row mb-0 text-center">
                                    <label class="col-xxl-6 col-xl-12 col-form-label mb-0 p-2 "> <strong> Nombre de la
                                            dieta</strong></label>
                    ...
                    <ul class="nav nav-pills nav-pills-success text-center row justify-content-center align-items-center"
                    ...
                    <div class="card">
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            @endphp
                            @for ($j = 0; $j <= 6; $j++)
                                <div class="tab-pane fade {{ $j == 0 ? 'show active' : '' }}" id="pills-dia{{ $j }}"
                                    role="tabpanel" aria-labelledby="pills-dia{{ $j }}-tab">
                                    <div class="accordion accordion-solid-header" id="accordion-{{ $j }}"
                                                        ...
                                                        <div>
                                                            <div>
                                                                <div class="container_buscador">
                                                                    ...
                                                                    <div
                                                                        class="container_buscador_desayuno col-12 text-center d-flex">
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            <option selected disabled>Seleccione un alimento
                                                                            </option>
                                        ...
                                        <div class="resultado"
                                            style="display:flex;  flex-wrap:wrap;padding-bottom:10px; justify-content:space-evenly; align-items:center">
                                            <div class="info_total"
                                                style="padding-top:10px; width:70%; text-align:center;">
                                                ...
                                                <div class="cuadro_informacion"
                                                    ...
                                                    <div>
                                                        <p><strong
                                                                style="margin-right:10px;font-size:18px;">Carbohidratos:</strong><i
                                                                style="font-weight:bold;font-size:18px;"
                                                                id="carbohidratosTotal{{ $j }}">0</i></p>
                                                    </div>
                                                    <div>
                                                        <p><strong
                                                                style="margin-right:10px;font-size:18px;">Grasas:</strong><i
                                                                style="font-weight:bold;font-size:18px;"
                                                                id="grasasTotal{{ $j }}">0</i></p>
                                                    </div>
                                                    <div>
                                                        <p><strong
                                                                style="margin-right:10px;font-size:18px;">Proteinas:</strong><i
                                                                style="font-weight:bold;font-size:18px;"
                                                                id="proteinasTotal{{ $j }}">0</i></p>
                                                    </div>
                                                    <div>
                                                        <p><strong
                                                                style="margin-right:10px;font-size:18px;">Kcal:</strong><i
                                                                style="font-weight:bold;font-size:18px;"
                                                                id="kcalTotal{{ $j }}">0/1500</i></p>
                                                    </div>
                                                </div>
                                            </div>
