        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class=" mb-3" style="background-color:#4b6ac3 ">
                    <h3
                        class="card-title text-lg-center mb-4 mt-4 text-white"style="text-transform: uppercase; font-weight:bold">
                        Datos de la actividad</h3>
                </div>
                                ...
                                <option value="" selected disabled>Seleccione la prioridad</option>
                                    ...
                                    <div
                                        ...
                                        <div class="col-md-8 p-0 col-xl-7 justify-content-space-around">
                                            ...
                                            <a class="btn btn-light mb-2 col-sm-12 col-md-4"
                                                href="{{ route('actividad.index') }}">Cancelar</a>
                                        </div>
                                    </div>
