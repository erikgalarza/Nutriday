        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class=" mb-5" style="background-color:#4b6ac3 ">
                    <h3 class="card-title text-lg-center mb-5 mt-5 text-white"style="text-transform: uppercase; font-weight:bold">Actividades</h3>
                </div>
                    <div class="card-body">
                        ...
                        <div style="display:flex; justify-content:space-evenly; flex-wrap:wrap;">
                            ...
                            <div class="card opciones text-center" style="width: 25rem;">
                                ...
                                <div class="card-body">
                                  ...
                                  data-target="#exampleModal{{ $actividad->id }}" style="border-radius:5px;width:5rem"><i
