                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-10 d-flex justify-content-center p-2"
                        ...
                        <div class=" mr-2 ml-2 align-items-center justify-content-center row">
                            <a title="Agregar una nueva medida" class="btn btn-success"
                                href="{{ route('medidaAlimento.create') }}"><i class="fas fa-plus mr-3"></i>Agregar </a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            @foreach ($medidas as $key => $medida)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a title="Editar datos de medida" class="btn btn-outline-warning mb-1"
                                            data-toggle="modal" data-target="#exampleModal-2{{ $medida->id }}"><i
                                                class="fas fa-edit"></i></a>

                                        <a title="Eliminar Medida" onclick="eliminarMedida({{ $medida }});"
                                ...
                                <form id="deletemedida{{ $medida->id }}" method="POST"
                                    action="{{ route('medidaAlimento.destroy', $medida->id) }}">
                                    @csrf
                                    @method('delete')
                                </form>
                                {{-- MODAL DE EDITAR CATEGORIA --}}

                                <div class="modal fade" id="exampleModal-2{{ $medida->id }}" tabindex="-1" role="dialog"
                                    aria-labelledby="ModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form method="POST" action="{{ route('medidaAlimento.update', $medida->id) }}"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header" style="background-color:#4b6ac3">
                                                    <h5 class="modal-title text-lg-center text-white"
                                                        ...
                                                        id="ModalLabel">Editar medida</h5>
                                                        ...
                                                        <div class="col-sm-10 col-11 text-left">
                                                            ...
                                                            <div class="form-group row mb-2">
                                                                <label class="col-sm-4 col-form-label text-left"
                                                                    for="recipient-name"><strong>Fecha
                                                                        creación:</strong></label>
                                                                <div class="col-sm-8">
                                                                    <label
                                                                        class="col-form-label">{{ date('Y-m-d', strtotime($medida->created_at)) }}</label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row mb-2">
                                                                <label class="col-sm-4 col-form-label text-left"
                                                                    for="recipient-name"><strong>Medida:</strong></label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" name="medida"
                                                                        class="form-control" value="{{ $medida->medida }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row mb-2">
                                                                <label class="col-sm-4 col-form-label text-left"
                                                                    for="recipient-name"><strong>Abreviatura:</strong></label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" name="abreviatura"
                                                                        class="form-control"
                                                                        value="{{ $medida->abreviatura }}">
                                                                </div>
                                                            </div>
