        ...
        <div class="card-body p-0 m-0">
            ...
            @if (count($pacientes) == 0)
                <div class="container"style="max-width:740px">
                    <div class="container">
                        <div class="row text-center justify-content-center  p-1 mb-3 bg-danger" style="border-radius:10px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            @if (count($paciente->actividades) > 0)
                                                <a data-toggle="modal" data-target="#exampleModal-4{{ $paciente->id }}"
                                                    class="btn btn-outline-info p-2" title="Ver actividades asignadas"><i
                                        ...
                                        <td>
                                            <a title="Asignar actividad"
                                                href="{{ route('actividad.asignar', base64_encode($paciente->id)) }}"
                                                class="btn btn-warning p-2"><i class="fas fa-plus"></i></a>
                                        </td>
                                </form>
                                </tr>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header" style="background-color: #4b6ac3">
                                                <h5 class="modal-title text-white" id="exampleModalLabel-2">Actividades
                                                    Asignadas a {{$paciente->nombre}}</h5>
                                            ...
                                            <div class="modal-body text-center" style=" padding:1.5rem 3rem">
                                                <div class="row mb-4 mt-2 " style="border-bottom:1px solid">
                                                    ...
                                                    <div class="col-2  font-weight-bold mb-2"><i class="far fa-clock"
                                                            title="Duración"></i></div>
