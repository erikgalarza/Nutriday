...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="{{asset('administracion/images/favicon.png')}}" />
</head>
          ...
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              ...
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2>Lo sentimos!</h2>
                <h3 class="font-weight-light">No hemos encontrado la página que estas buscando.</h3>
              </div>
            </div>
            <div class="row mt-5">
            ...
            <div class="row mt-5">
              <div class="col-12 mt-xl-2">
                <p class="text-white font-weight-medium text-center">Copyright &copy; {{date('Y')}} Todos los derechos reservados.</p>
              </div>
            </div>
          </div>
        </div>
