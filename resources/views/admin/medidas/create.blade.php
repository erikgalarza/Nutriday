                ...
                <div class="card-body">
                    <div class="col-12 row justify-content-center px-0 m-0">
                        <div class="col-md-8 col-xl-9 col-11 text-left pl-md-0">
                            ...
                            <form method="POST" class="forms-sample" action="{{ route('medidaAlimento.store') }}"
                                ...
                                <div class="container" style="max-width: 621px">
                                    ...
                                    <div class="form-group row mb-3">
                                        <label
                                            style="font-weight:bold; font-size:12px; text-transform:uppercase;max-width:207px"
                                            for="exampleInputUsername2" class="col-xl-4  col-form-label ">Nombre de la
                                            medida:</label>
                                        <div class="col-xl-8 ">
                                    ...
                                    <div class="form-group row ">
                                        <label
                                            style="font-weight:bold; font-size:12px; text-transform:uppercase;max-width:207px"
                                            for="exampleInputUsername2" class="col-xl-4 col-form-label">Abreviatura de la
                                            medida:</label>
                                        <div class="col-xl-8">
                                    ...
                                    <div
                                        ...
                                        <div class="col-md-8 p-0 col-xl-5 justify-content-space-around">
                                            ...
                                            <a class="btn btn-light mb-2 col-sm-12 col-md-5"
                                                href="{{ route('medidaAlimento.index') }}">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
