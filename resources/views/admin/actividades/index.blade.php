                            ...
                            <tr>
                                ...
                                <td>
                                    <a title="Ver descripción" data-toggle="modal"
                                        data-target="#exampleModal-3{{ $actividad->id }}" class="btn btn-outline-info"><i
                                            class="fas fa-eye"></i></a>
                                    <a class="btn btn-outline-warning" data-toggle="modal"
                                        data-target="#exampleModal-2{{ $actividad->id }}"><i class="fas fa-edit"></i></a>
                                        ...
                                        <div class="modal-body" style="padding:1.5rem 6rem">
                                            ...
                                            <form method="POST" action="{{ route('actividad.update', $actividad->id) }}">
                                                ...
                                                <div class="col-12  mt-3">
                                                    ...
                                                    <div class="form-group row mb-2" style="font-weight:bold;font-size:12px;">
                                                        <label for="exampleInputUsername2"
                                                            class="col-sm-3 col-form-label text-left">Agregar nueva imagen:</label>
                                                        <div class="col-sm-9">
                                                    ...
                                                    <div class="form-group row mb-1">
                                                        <label class="text-left col-sm-3 col-form-label"> <strong> Imagen actual:</strong></label>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body d-flex text-center">
                                                ...
                                                <div class="col-12 mt-3">
                                                    ...
                                                    <div class="form-group row mb-1">
                                                        <label class="col-4 text-left"><strong>Descripción:</strong></label>
                                                        <label
                                                            class="col-8 text-left">{{ $actividad->descripcion }}</label>
