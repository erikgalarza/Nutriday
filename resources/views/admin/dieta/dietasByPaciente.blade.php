...
@section('contenido')
    ...
    <div class="card">
        ...
        <div class=" mb-2" style="background-color:#4b6ac3 ">
            <h3 class="card-title text-center mb-4 mt-4 text-white"style="text-transform: uppercase; font-weight:bold">
                Dietas del paciente {{ $paciente->nombre }} {{ $paciente->apellido }}</h3>
        </div>
        <div class="card-body">
            <!-- ----------------------------------------------------------------------------------------------------- -->
            ...
            <div class="container container2 container3 container4 ">
                ...
                <div class="container py-3  text-center">
                    <a title="Asignar una dieta predefinida a {{$paciente->nombre}}" data-toggle="modal" data-target="#exampleModal-4{{ $paciente->id }}"
                        class="btn btn-success"><i class="fas fa-share mr-2"></i> Asignar dieta </a>
                    <a title="Crear una dieta personalizada a {{$paciente->nombre}}" onclick="event.preventDefault();
            document.getElementById('formCrearDieta').submit();"
                                ...
                                <table id="order-listing" class="table text-center">
                                    ...
                                    <tbody>
                                        @foreach ($dietas as $key => $dieta)
                                            ...
                                            <div class="modal fade" id="exampleModal-4{{ $paciente->id }}"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body py-3 px-0">
                                                            ...
                                                            <div class="col-12 row m-0 justify-content-center">
                                                                <div
                                                                    class="col-sm-10 col-11 text-left justify-content-center">
                                            ...
                                            <div class="modal fade" id="exampleModal-2{{ $dieta->id }}"
                                                tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-2"
                                                aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header" style="background-color:#4b6ac3">
    ...
    {{ old('categoria_id', $producto->categoria_id) == $categoria->id ? 'selected' : '' }}> --}}
                                            ...
                                            <div class="modal fade" id="exampleModal-3{{ $dieta->id }}"
                                                tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
